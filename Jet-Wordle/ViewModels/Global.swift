...
enum Global {
    ...
    static var minDimension: CGFloat{
        min(screenWith, screenHeight)
    }
    
    static var boardWidth:  CGFloat{
        switch minDimension {
        case 0...320:
            return screenWith - 55
        case 321...430:
            return screenWith - 50
        case 431...1000:
            return 350
        default:
            return 500
